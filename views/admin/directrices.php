      ...
      <!-- Small boxes (Stat box) -->
       ...
       <div class="box">
            <div class="box-header">
              <h3 class="box-title">Directrice</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php foreach ($directrices as $directric) : ?>
                <tr>
                    <td><?php echo $directric['id']; ?></td>
                    <td><?php echo $directric['nom']; ?></td>
                    <td><?php echo $directric['prenom']; ?></td>
                    <td><?php echo $directric['contact']; ?></td>
                    <td><?php echo $directric['email']; ?></td>
                    <td><?php echo $directric['adresse']; ?></td>
                    <td><?php echo $directric['section']; ?></td>
