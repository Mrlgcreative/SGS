    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo BASE_URL; ?>index.php?controller=Admin&action=addFrais"><i class="fa fa-circle-o"></i> Voir Frais</a></li>
            <li><a href="<?php echo BASE_URL; ?>index.php?controller=Admin&action=frais"><i class="fa fa-circle-o"></i>Ajout frais</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="form-group  has-feedback">
      ...
      <div class="container">
        ...
        <form action="index.php?controller=Admin&action=ajoutCours" method="POST">
    ...
    <label for="professeur_id">ID du professeur:</label>
    <input type="number" class="form-control" id="professeur_id" name="professeur_id" required>

    <label for="classe_id">ID de la classe:</label>
    <input type="number" class="form-control" id="classe_id" name="classe_id" required>
    ...
    <textarea id="option" class="form-control"  name="option"></textarea>

    <input type="submit" class="btn btn-info" value="Ajouter le cours">
</form>
